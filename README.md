# Fork of PapyElGringo's AwesomeWM called Materia-Awesome to SomeWM
...
An almost desktop environment made with [SomeWM](https:/somewm.org/) following the [Material Design guidelines](https://material.io) with a performant opiniated mouse/keyboard workflow to increase daily productivity and comfort.
...
```
git clone https://github.com/H0R1Z0N/H0R1ZON-Materia-SomeWM.git  ~/.config/somewm
```
